...
// 写入测试HTML文件
fs.writeFileSync(path.join(__dirname, 'debug-chart.html'), testHtml);
console.log('已创建测试文件: debug-chart.html');
console.log('请在浏览器中打开此文件进行测试'); 